...
export const comparisonRecipes = Object.freeze({
  ...
  careful: createRecipe({
    group: 'operation',
    label: '誤操作防止',
    purpose: '商品タップの誤操作を抑える',
    effectSummary: '安全タップ・取消時間は利用者設定',
    settings: {
      scenario: 'normal',
      cardMinWidth: 230,
      rowSpacing: 'standard',
  ...
  aggregateQuantity: createRecipe({
    group: 'operation',
    label: '数量境界確認',
    purpose: '数量別の入力方式と8注文単位を確認',
    effectSummary: '6個以下は直接選択・7個以上はステッパー',
    settings: {
      scenario: 'normal',
      cardMinWidth: 230,
      rowSpacing: 'standard',
  ...
  instant: createRecipe({
    group: 'operation',
    label: '高速運用',
    purpose: '詰めた表示で高速確認する',
    effectSummary: '詰める・全数完了・取消時間は利用者設定',
    settings: {
      scenario: 'normal',
      cardMinWidth: 230,
      rowSpacing: 'compact',
  ...
  currentTiming: createRecipe({
    group: 'situation',
    label: '現行時間仕様',
    purpose: '稼働中画面の遅延判定と比較',
    effectSummary: '10分・事前警告なし・経過表示',
    settings: {
      scenario: 'delay',
      cardMinWidth: 230,
      rowSpacing: 'standard',
...
export const comparisonQuantityInteractionModeOptions = Object.freeze([
  Object.freeze({ id: 'aggregate', label: '同一商品の注文別内訳モーダル' }),
]);
...
export const comparisonOptions = Object.freeze({
  ...
  columnCounts: Object.freeze(['3', '4']),
  cardMinWidths: Object.freeze([230]),
  ...
  orderUndoMs: Object.freeze([5000]),
  itemHideMs: Object.freeze([5000]),
  targetMinutes: Object.freeze([10, 15, 20, 30]),
  warningMinutes: Object.freeze([0, 3, 5]),
  orderTimeDisplayModes: Object.freeze(
